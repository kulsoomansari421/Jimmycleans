            ...
            <div className="flex flex-col lg:flex-row justify-between gap-10 mb-10">
              ...
              <div className="w-full sm:max-w-70">
                ...
                <div className="flex items-center gap-2">
                  <a
                    href="https://www.instagram.com/jimmycleansnj/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-8 h-8 rounded-xl border border-[rgba(255,255,255,0.8)] bg-white/60 flex items-center justify-center text-[#6b7280] hover:text-[#E1306C] hover:border-[#E1306C] hover:bg-white/80 transition-all duration-200 shadow-sm"
                  >
                  ...
                  <a
                    href="https://www.facebook.com/profile.php?id=61582880371718"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-8 h-8 rounded-xl border border-[rgba(255,255,255,0.8)] bg-white/60 flex items-center justify-center text-[#6b7280] hover:text-[#1877F2] hover:border-[#1877F2] hover:bg-white/80 transition-all duration-200 shadow-sm"
                  >
